...
public final class DBSLog
{
	private static String loggerName = "DBSLogger";
    protected static org.apache.log4j.Logger DBSLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DBS_SysIntegration_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;
			dynamicLog = "Logs/DBS_SysIntegration_Logs/"+logDateFormat.format(date)+"/DBS_SystemIntegration_Log.xml";
