...
public class ResponseBean {
	...
	public String getDedupeIntError() {
		return DedupeIntError;
	}
	public void setDedupeIntError(String dedupeIntError) {
		DedupeIntError = dedupeIntError;
	}
	public String getFircoIntError() {
		return FircoIntError;
	}
	public void setFircoIntError(String fircoIntError) {
		FircoIntError = fircoIntError;
	}
	public String getBlacklistIntError() {
		return BlacklistIntError;
	}
	public void setBlacklistIntError(String blacklistIntError) {
		BlacklistIntError = blacklistIntError;
	}
	private String FircoHit="";
	private String FinalDecision = "";
	private String DedupeIntError="";
	private String FircoIntError="";
	private String BlacklistIntError = "";
